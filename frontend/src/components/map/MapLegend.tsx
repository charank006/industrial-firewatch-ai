      ...
      {isExpanded ? (
        <div className="p-2.5 bg-[#081019]/95 border border-[#253340] rounded-lg backdrop-blur-md shadow-xl space-y-2 max-w-xs animate-in fade-in slide-in-from-bottom-2 duration-150">
          ...
          <div className="grid grid-cols-2 gap-x-3 gap-y-1.5 text-[10px]">
            <div className="flex items-center space-x-1.5 col-span-2 bg-[#A855F7]/10 p-1 rounded border border-[#A855F7]/30">
              <span className="w-2.5 h-2.5 rotate-45 bg-[#A855F7] border border-white shrink-0" />
              <span className="text-[#A855F7] font-semibold">Persistent Source (&ge;5/7d)</span>
            </div>
            ...
            <div className="flex items-center space-x-1.5">
              <span className="w-2.5 h-2.5 rounded-full bg-[#FFB020] shrink-0" />
